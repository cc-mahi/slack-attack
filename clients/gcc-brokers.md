...
last_catchup: 2026-07-16T15:02:20Z
---
...
> [resolved] 2026-07-16 — TOB/market-depth spread config query answered; confirmed uniform across all clients
...
> [resolved] 2026-07-14 — 2,014oz XAUUSD long filled on Finalto, Compass adjustment done
> Layan reported 2,014oz gold long filled on Finalto at 15:21 BST; Rory King confirmed "this has been actioned" at 16:39 BST. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1784038914279449)

> [resolved] 2026-07-13 — 4,983oz XAUUSD long filled on Finalto, Compass adjustment done
> Layan reported 4,983oz gold long filled on Finalto at 15:26 BST; Rory King confirmed "this has been actioned" at 15:46 BST. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1783952775869009)

> [resolved] 2026-07-10 — 576oz XAUUSD long filled on Finalto, Compass adjustment done
> Layan reported 576oz gold long filled on Finalto at 15:10 BST; William confirmed "this is done" at 15:18 BST. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1783692634631619)

> [resolved] 2026-07-09 — 16oz XAUUSD short filled on Finalto, Compass adjustment done
> Layan reported 16oz gold short filled on Finalto at 15:58 BST; William confirmed "this is done" at 16:59 BST. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1783609098345639)
...
> William ran SI (Skew + Inventory) sims on XAUUSD flow into CLIENTS_LDN (98% of flow) since 4 May across Jenkins builds 606–611, 595–596. 2hr SI window is best-performing ($105/M), 1hr next ($70/M), both well above the current fast-hedge A-book ($11/M). William's read: sharp flow means B-book PnL is consistently decreasing, so risk management stays crucial even with SI. Separately sanity-checked a $250k 2hr SI PnL spike on 4 May — confirmed legitimate soft flow, not an error. Delivers on David Cooney's 2026-07-01 request ("happy with everything now, looking to take it to the next level"). 2026-07-06: William walked Youssef through the findings; GCC confirmed they want to move forward with getting SI live. Daria asked what risk-transfer window and starting percentage will be used, and whether risk-by-window charts/data are ready — unanswered in window. 2026-07-09: William told the client he's ready to put soft flow into SI starting with a 30-minute hold period; client agreed to go ahead (14:26–14:27 BST). Isaac Dann flagged internally at 22:23 BST that SI was still disabled by a catch-all rule splitting 0% of all XAUUSD (blocking the intended 10% split); William found no flow was reaching the soft counterparties either, so decided to go live with all non-fast-hedge flow the next day (2026-07-10), which coincides with the NZ bank holiday. Isaac confirmed "all good, easy as". 2026-07-10: William reported SI live but "very slow" on the day — currently holding risk only on B-book classified flow, with no Fast Hedge-classified risk routed to off-book. Flagged that if SI stays slow into next week it may be worth adding other classifications. Nael separately raised concern about SI taking on risk 10–15 mins before EOW market close (a recurring pattern for GCC); William planned to switch SI off ahead of that close and build an automatic off-book hedger for the EOW window going forward. 2026-07-14: Nathan Burch confirmed SI has been turned back on (was switched off ahead of the 2026-07-10 EOW close per plan); A_CLIENT flow split into the SI book is the flow classified `SHOULD_B_BOOK`. Same day, Daria Horton reviewed fasthedge whitelisting ahead of the SI move: removed fasthedge whitelisting from all counterparties that had traded in the prior 4 weeks (checked each was either already picked up dynamically by the classifier or shouldn't have been included), noting the classifier should make the call given classifications now drive SI routing. Also removed CPs 4004096 and 4003986 from the broker and fast-hedge lists — both sit in a rehab gap between the 500k bad-check threshold and the 1m good-check threshold, trading enough to get a bad classification but not enough to rehabilitate; the classifier can re-add them if broker becomes suitable again. [sim-results](https://mahifx.slack.com/archives/C09QS1NUA80/p1783081002827819) [spike-check](https://mahifx.slack.com/archives/C09QS1NUA80/p1783081149212709) [go-live-decision](https://mahifx.slack.com/archives/C09QS1NUA80/p1783346437672379) [daria-questions](https://mahifx.slack.com/archives/C09QS1NUA80/p1783373192893709) [client-go-ahead](https://mahifx.slack.com/archives/C09PNC1MFAA/p1783603612430239) [catch-all-blocker](https://mahifx.slack.com/archives/C09QS1NUA80/p1783632181887349) [go-live-plan](https://mahifx.slack.com/archives/C09QS1NUA80/p1783633184921549) [go-live-day1-status](https://mahifx.slack.com/archives/C09QS1NUA80/p1783703010869539) [si-back-on](https://mahifx.slack.com/archives/C09QS1NUA80/p1784000032090629) [fasthedge-whitelist-review](https://mahifx.slack.com/archives/C09QS1NUA80/p1784068031754419) [cp-4004096-declassified](https://mahifx.slack.com/archives/C09QS1NUA80/p1784069088631079)
...
> [open] 2026-07-02 — 1,416oz XAUUSD long filled on Finalto, Compass adjustment in progress
> Layan reported 1,416oz gold long filled on Finalto at 15:08 BST; William acknowledged "Hi Layan, adjusting" at 15:08 BST. No completion confirmation in window. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1783001309991439)

> [resolved] 2026-07-01 — 800oz XAUUSD long filled on Finalto, Compass adjustment done
> Layan reported 800oz gold long filled on Finalto at 15:09 BST; William confirmed "This is done" at 15:56 BST. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1782914956443639)

> [open] 2026-06-30 — A-book hedger loss -$11k; VaR clearance and backstop tuned
> Isaac Dann flagged a loss at GCC at 02:38 BST: flow went offside -$11k at 30 seconds; VaR clearance rules too slow for small-size trades. Config changes applied: XAUUSD VaR per second raised from 500→1500; VaR clearance rule speed raised 100→150; LMAX and Finalto VaR clearance speed raised 150→250; 10-second delay added to backstop rule triggering at 5,000% max VaR ($5k VaR absolute, hedger max VaR = 100). Backstop cleared well after 30 seconds per Isaac. No stability follow-up in window. [permalink](https://mahifx.slack.com/archives/C09QS1NUA80/p1782783499457139)

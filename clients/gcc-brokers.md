...
last_catchup: 2026-05-19T07:29:21Z
---

## Recent issues

> [open] 2026-05-15 — XAGUSD unhedged ~1h30m during sell-off; ~$70k client P&L loss; client at risk
> hybridHedger1 (last started 2026-05-10) had a FINALTO maximumMarketPosition cap of 7,500oz baked in at startup; Nathan's 2026-05-13 config override to 20k was never picked up (maximumMarketPosition is not hot-reloaded). XAGUSD was switched to internalisation 2026-05-14 (separate entry) — this was the first time the 7,500oz cap became binding. From 09:16 UTC the BACKSTOP rule attempted LMAX, but LMAX widened beyond BaseSpread×200% at 09:50 during a 5×5000oz rush buy; the backstop rule's LMAX-only offer allocation had no liquidity, leaving ~45,200–45,700oz XAG unhedged until 10:46 UTC when BACKSTOP resolved. Client (Nael/Youseff/Khalil) reported at 11:25 UTC; Will Carter called "client at risk", ~$70-80k P&L impact stated. Kate/Rory/Will triaged; hedger restarted; positions traded out manually. Will called Youseff at ~14:37 BST. Youseff's pasted message (relayed by David Cooney): "80K off our P&L… due to a silly misconfiguration… unacceptable… we are way beyond misconfigurations and trial and error at this stage". Root cause confirmed: hedger startup loaded old 7,500oz cap (ImmutableTable built at startup in ExecutionStrategyBuilder.java:472–484). Will proposed full-ownership response — cap explanation, hedger restart, hot-reload fix, divergence alert. Kate posted post-mortem PDF 2026-05-18. Fix-up: Daria bumped XAGUSD maximumMarketPosition to 100k on 2026-05-17; Kate stripped both XAU and XAG max market position config entirely and bounced hybridHedger1 on 2026-05-18. UI roadmap item raised to add post-save modal reminding operators to restart affected processes (Justin Young picked it up). [client alert](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778840703789279) [internal root cause](https://mahifx.slack.com/archives/C09QS1NUA80/p1778852156056869) [Will's client message draft](https://mahifx.slack.com/archives/C09QS1NUA80/p1778852509402759) [Youssef quote via David](https://mahifx.slack.com/archives/C09QS1NUA80/p1778848450995579) [post-mortem uploaded](https://mahifx.slack.com/archives/C09QS1NUA80/p1779101281240979) [Daria max position bump](https://mahifx.slack.com/archives/C09QS1NUA80/p1779051773373389) [Kate stripped config](https://mahifx.slack.com/archives/C09QS1NUA80/p1779100100594529)

> [resolved] 2026-05-14 — XAGUSD switched to internalisation + fast-hedge
> William proposed XAGUSD internalisation on 2026-05-14 after reviewing Echo yield profiles (past month's flow suitable). Test confirmed at 14:13 BST; went live. Client confirmed they thought XAGUSD was already enabled alongside XAUUSD. Daria shared rollover hedger performance for XAUUSD (~$13k saved, $71/M) and XAGUSD (~$920 saved, $59/M). [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778754219771339)

> [resolved] 2026-05-13 — Futures fast-hedge test trades completed; metals + indices futures switched to internalise
> William ran through test trades with client (Nael, tag 4036) on 2026-05-13: XAU, XAG, NDX, SPX, DOW, DAX futures — all hedged and confirmed. Metals + indices futures flow switched to internalise. USOIL/UKOIL/NGAS: hedger setup nearly complete per William 2026-05-13 19:03; William bounced futures hedgers on 2026-05-14 to pick up oil futures mapping. No confirm that USOIL/UKOIL/NGAS have been switched live yet. [test trades start](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778690668796219) [USOIL/UKOIL/NGAS status](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778695014614019) [futures hedger bounce](https://mahifx.slack.com/archives/C09QS1NUA80/p1778747883886949)

> [resolved] 2026-05-13 — XAUUSD position divergence; positions reconciled by Nathan
> Client (Carl) reported volume stuck from the close-by process at 21:25 BST; Daria identified XAUUSD 15k LP position cap as likely cause (positions diverged). Raised the limit with client consent. Nathan reconciled positions at 23:33 BST; confirmed complete. Client confirmed XAGUSD/XAUUSD exposure snapshot: XAUUSD flat, XAGUSD Finalto 111k / LMAX 124.9k / Client 235.9k. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778703945959439)
...
> [resolved] 2026-05-06 — Fast-hedge for futures requested; tags 4004072/4004241 slipping on gold futures
> Client asked for fast-hedge setup on futures ASAP — specifically tags 4004072 and 4004241 are experiencing slippage on gold futures. William acknowledged aim to deliver and will keep updated; no timeline given. 2026-05-07: client reiterated "Yes please important for the futures" after go-live of CFD Indices; William confirmed "Futures setup still in progress, will let you know when that's ready to go". 2026-05-12: William updated Nael that restructuring the futures workflow to enable fast hedging was underway, needing a couple more restarts. 2026-05-13: test trades completed, metals + indices futures switched to internalise (see separate 2026-05-13 entry). [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778060389989769) [2026-05-07 update](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778160477670339) [2026-05-12 update](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778576488756259)
...
- 2026-05-18 — UI roadmap: Justin Young picked up Will's post-incident request to add a post-save modal in Compass UI that lists affected processes and offers inline restart, triggered for non-dynamic `hedging.*`, `pricing.*`, `distribution.*` keys. Roadmap entry `docs/roadmap/short-term-ui-roadmap.md:125`. [permalink](https://mahifx.slack.com/archives/C09QS1NUA80/p1779085027341739)
- 2026-05-18 — 6,710oz XAUUSD long filled on Finalto; Layan reported, William confirmed Compass adjustment done. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1779117985727249)
- 2026-05-15 — Liam, Will, Kate reflection on Claude usefulness during incident: ~2h each spent trying to coax sessions past false assumptions; breakthrough came only when Will checked Config Audit manually. Liam noted he wouldn't normally have delayed that check but was "locked into clauding". [permalink](https://mahifx.slack.com/archives/C09QS1NUA80/p1778855033172619)
- 2026-05-14 — Daria shared rollover hedger savings: XAUUSD ~$13k ($71/M), XAGUSD ~$920 ($59/M) vs previously paid spreads. [permalink](https://mahifx.slack.com/archives/C09PNC1MFAA/p1778731913293849)

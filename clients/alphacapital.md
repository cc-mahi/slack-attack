...
last_catchup: 2026-05-19T07:15:04Z
---

## Recent issues

> [resolved] 2026-05-15 — signalProcessCFDFI1 down: counter file lock contention with signalProcessFI1
> Arun Patel: signalProcessCFDFI1 failed to start due to exclusive-lock contention on the NZDUSD ADWeights counter file (`var/ADWeights.NZDUSD.IFMS.FM-5000-50-NQT-0-0-0-...counter`) held by signalProcessFI1. Resolved by Arun same hour. [permalink](https://mahifx.slack.com/archives/C06UHTDQ8JF/p1778847108444079)

> [open] 2026-05-18 — signalProcessFI1 / signalProcessCFDFI1 compute: aeron subscriber latency spikes
> Arun Patel: downstream `marketDataLatency` spikes linked to signalProcessFI1 and signalProcessCFDFI1 compute load; bumped `jvm_max_memory` on signalProcessCFDFI1 as interim. Asked whether signals can be removed or compute freed on both processes — no response yet. [permalink](https://mahifx.slack.com/archives/C06UHTDQ8JF/p1779113656227239)
...
- 2026-05-13 — Argamon LD Centroid bridge migration: new IP. David Rapp (Argamon) notified that Argamon's LD Centroid bridge instance migrated server on Sat 16 May (downtime 2100 UTC Fri 15 May – 2100 UTC Sat 16 May). New IP: `192.109.17.170`; DNS `arguk.centroidsol.com` resolves automatically. Cameron Hughes acknowledged and actioned. [permalink](https://mahifx.slack.com/archives/C070016ND6X/p1778658472423589)

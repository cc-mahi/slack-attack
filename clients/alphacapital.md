...
last_catchup: 2026-05-15T07:09:02Z
---

## Recent issues

> [open] 2026-05-13 — Argamon LD Centroid bridge server migration (downtime Fri 15 May 2100 UTC – Sat 16 May 2100 UTC)
> David Rapp (ACG Markets CEO) forwarded Argamon's notice in #mahi-alphacapitalgroup: Argamon's LD Centroid bridge instance migrating server this weekend. Planned downtime 2100 UTC Friday 15 May → 2100 UTC Saturday 16 May. New IP post-migration: 192.109.17.170. DNS `arguk.centroidsol.com` auto-resolves, no action needed if targeting DNS. Cameron Hughes acknowledged: "we'll action the changes needed our side" — no confirmation of completion yet. Directly affects Alpha's SI hedging leg (fixMarketData/OrderArgamon1 via OZ/Centroid). [permalink](https://mahifx.slack.com/archives/C070016ND6X/p1778658472423589)

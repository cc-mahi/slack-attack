...
last_catchup: 2026-05-18T07:18:25Z
---

## Recent issues

> [resolved] 2026-05-15 — signalProcessCFDFI1 down: counter file lock contention with signalProcessFI1
> Arun Patel: signalProcessCFDFI1 failed to start due to exclusive lock contention on ADWeights.NZDUSD.IFMS counter file held by signalProcessFI1. Resolved by Arun ~50 min later (process started successfully). [permalink](https://mahifx.slack.com/archives/C06UHTDQ8JF/p1778847108444079)
...
- 2026-05-13 — Argamon Centroid bridge server migration (2026-05-15/16). David Rapp (Argamon) forwarded Centroid notice: LD Centroid bridge migrating to new IP 192.109.17.170 (DNS arguk.centroidsol.com) with downtime 2100 UTC 2026-05-15 to 2100 UTC 2026-05-16. Cameron Hughes acknowledged and actioned changes on Mahi side. No IP-retarget needed if connecting via DNS. [permalink](https://mahifx.slack.com/archives/C070016ND6X/p1778658472423589)

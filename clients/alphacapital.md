...
> [open] 2026-05-15 — signalProcessFI1 / signalProcessCFDFI1 lock contention and compute pressure
> signalProcessCFDFI1 went down 2026-05-15 ~12:04 UTC due to exclusive-lock contention on an ADWeights counter file (NZDUSD IFMS variant) held simultaneously by signalProcessFI1 — both processes racing for the same `.counter` file. Arun Patel bumped `jvm_max_memory` on signalProcessCFDFI1 as immediate workaround. 2026-05-18 follow-up: Arun asking whether signals can be pruned / compute freed on both signalProcessFI1 and signalProcessCFDFI1 to address downstream `marketDataLatency` / aeron subscriber latency spikes (Grafana link in thread). No resolution confirmed; thread reply from 2026-05-15 14:03 BST unread (permission denied). [permalink](https://mahifx.slack.com/archives/C06UHTDQ8JF/p1778847108444079) [2026-05-18 follow-up](https://mahifx.slack.com/archives/C06UHTDQ8JF/p1779113656227239)
...
- 2026-05-13 — Argamon Centroid bridge server migration (2026-05-16). David Rapp (Argamon) notified Alpha Capital channel: LD Centroid bridge migrating server Fri 2026-05-16 21:00 UTC → Sat 2026-05-16 21:00 UTC; new IP `192.109.17.170`. DNS `arguk.centroidsol.com` auto-resolves, no action needed if using DNS. Cameron Hughes acknowledged and confirmed Mahi-side changes actioned. [permalink](https://mahifx.slack.com/archives/C070016ND6X/p1778658472423589)

...
last_catchup: 2026-05-19T07:17:03Z
status: active
retired_at: null
retired_reason: null
---
...
> [open] 2026-05-05 — new crypto pairs expansion request (22 pairs; 4 still pending deploy)
> Benjamin Galindo (@here tagged) requested 22 new crypto pairs. As of 2026-05-18 Isaac Dann confirmed 15 are live; TONUSD, THETA, OKBUSD, KCSUSD need a system deploy. Two instruments require client confirmation before proceeding: MKRUSD has been replaced by SKY token (1 MKR = 24,000 SKY — price will differ materially); EOS has been relisted as Vaulta at most exchanges (1:1 swap, price unchanged). XMR is available via Kraken only. No client response on MKR/EOS/VAULTA yet; deploy for remaining 4 not yet scheduled. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1779061823.502329)

> [resolved] 2026-05-08 — Mahi coordinated trading detection script delivered
> BrightFunded requested the coordinated trading correlation script (2026-05-08). Cameron Hughes delivered the first weekly CSV (`brightfunded_coordinated_trading_2026-05-05_2026-05-12.csv`) on 2026-05-12; client (Mio Knights) acknowledged and said they'd follow up with questions. BF intends to pair this with new fingerprinting software for multi-account detection. Mio also flagged they're working on abusive trading behaviour detection and will reach out to Mahi to collaborate. Weekly delivery cadence now established. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778602892.678569)

> [open] 2026-05-12 — account purchase volumes dropped in April; BF asking if industry-wide
> 2026-05-12 bi-weekly (Cameron Hughes): BrightFunded noticed account purchase counts and volumes fell in April and want to know if this is an industry-wide trend. No Mahi response visible in window. Also at the bi-weekly: new programs performing well, pass rates closely matching sim results; BF implementing a fingerprinting tool to prevent multi-account holders (client policy: no holding multiple accounts); plan to pair fingerprinting with Mahi coordinated trading detection. Mio Knights working on abusive trading behaviour detection and will reach out to Mahi to collaborate. [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778581203.791929)
...
- 2026-05-12 bi-weekly: crypto instrument pricing — BF flagged that Match pricing would significantly increase costs on the new instruments; they want Mahi to price using other LPs instead. Isaac's 2026-05-18 update (15 live) addresses 15 of 22 via Mahi pricing; deploy pending for remaining 4. [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778581203.791929)
- Internal (2026-05-15): Andrew Morgan queried BrightFunded's fingerprinting approach after bi-weekly notes; Cameron H confirmed payment fingerprinting. Daria noted Pepper does similar (counterparty toxicity prediction → direct A-book routing). [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778855749.308349)

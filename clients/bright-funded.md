...
last_catchup: 2026-05-13T07:16:34Z
status: active
retired_at: null
retired_reason: null
---
...
> Benjamin Galindo (@here tagged) requested 22 new crypto pairs: XMR, BCH, ETC, MKR, TON, HBAR, ICP, VET, THETA, EOS, AVAX, ATOM, MANA, SAND, OKB, KCS, GRT, PYTH, EGLD, XTZ, COMP, SNX. Isaac Dann confirmed 20 can be added immediately; OKB and KCS require a code change and deployment. On 2026-05-06 Benjamin confirmed MatchTrade pricing and said he'd check with MT on OKB/KCS availability. On 2026-05-08 Benjamin asked whether Mahi pricing could be used for those instruments instead. On 2026-05-11 Benjamin chased again (tagging Mio Knights) — no Mahi resolution on the OKB/KCS code change yet. 2026-05-12 bi-weekly: Match pricing would significantly increase BF costs on the new instruments — client wants Mahi LP pricing as an alternative; no resolution confirmed yet. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778006518033119)

> [open] 2026-05-08 — client requesting Mahi copy/group trading correlation script
> BrightFunded (Benjamin Galindo) asked on 2026-05-08 whether Mahi still has a trading correlation script for detecting copy/group trading, intending to combine it with new fingerprinting software for multi-account detection as a weekly review process. Cameron Hughes acknowledged on 2026-05-11 ("Hey Ben, let me check the progress on that one") but no script or timeline confirmed yet. On 2026-05-12 Cameron H sent a weekly coordinated trading detection CSV (brightfunded_coordinated_trading_2026-05-05_2026-05-12.csv) to #mahi-brightfunded; client replied "will let you know if there are any questions" ✅ — suggests interim delivery is accepted but the underlying script/collaboration (Mio to reach out) remains outstanding. Also 2026-05-12 bi-weekly: BF implementing fingerprinting to prevent multiple accounts; Mio is working on detecting abusive trading behaviour and will be reaching out to collaborate with Mahi on this. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778240384530379)
...
- Bi-weekly call (2026-05-12): BF observed account purchases and volumes dropped in April; want to know if this is industry-wide. New programs performing well and closely matching sim results. No multiple-account policy — implementing fingerprinting tool. Mio working on abusive-trading detection and will collaborate with Mahi. New instrument pricing via Match would significantly raise costs; want Mahi LP alternative. [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778581203791929)
- Coordinated trading weekly delivery (2026-05-12): Cameron H sent brightfunded_coordinated_trading_2026-05-05_2026-05-12.csv directly to #mahi-brightfunded; client acknowledged positively. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778602892678569)

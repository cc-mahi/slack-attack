...
last_catchup: 2026-05-18T07:20:27Z
status: active
retired_at: null
retired_reason: null
---
...
> [watching] 2026-05-12 — account volumes declining; BF implementing fingerprinting to combat multi-account abuse
> 2026-05-12 bi-weekly call notes (Cameron Hughes): BrightFunded has noticed account purchases and volumes dropping in April and asked if it's an industry-wide trend. New programs performing well, closely matching Mahi sim results. BF does not allow traders to hold multiple accounts (unlike many peers) and is implementing a fingerprinting tool to prevent it — Cameron H confirmed on 2026-05-15 it's payment fingerprinting. Mio Knights is working on detecting abusive trading behaviour and will reach out to collaborate with Mahi. Andrew Morgan noted on 2026-05-15 that Pepper uses similar fingerprinting to predict toxic accounts and route them directly to A-book. [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778581203791929) [fingerprinting thread](https://mahifx.slack.com/archives/C084G40JXEE/p1778855749308349)

> [open] 2026-05-05 — new crypto pairs expansion request (22 pairs; deploy + rebrands pending)
> Benjamin Galindo (@here tagged) requested 22 new crypto pairs: XMR, BCH, ETC, MKR, TON, HBAR, ICP, VET, THETA, EOS, AVAX, ATOM, MANA, SAND, OKB, KCS, GRT, PYTH, EGLD, XTZ, COMP, SNX. Isaac confirmed 15 are now priced using Mahi LPs (MatchTrade pricing deemed too costly). Four require a deploy: TONUSD, THETA, OKB, KCS. Two need client clarification: MKR has been rebranded to SKY (1 MKR → 24,000 SKY; price differs significantly) and EOS has been relisted as Vaulta A/USD (1:1, same price) — Isaac awaiting BF's instructions on both. XMR priced via Kraken. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778006518033119) [Isaac update 2026-05-18](https://mahifx.slack.com/archives/C08473TFD7Z/p1779061823502329)

> [resolved] 2026-05-08 — client requesting Mahi copy/group trading correlation script
> BrightFunded (Benjamin Galindo) asked on 2026-05-08 whether Mahi still has a trading correlation script for detecting copy/group trading, intending to combine it with new fingerprinting software for multi-account detection as a weekly review process. Cameron Hughes acknowledged on 2026-05-11 and delivered the first weekly coordinated trading report (CSV, week of 2026-05-05–2026-05-12) on 2026-05-12; client confirmed receipt. Weekly cadence now in flight. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778240384530379) [delivery permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778602892678569)
...
- Weekly coordinated trading report cadence established (2026-05-12): Cameron Hughes delivered first CSV (2026-05-05–2026-05-12) to #mahi-brightfunded; client confirmed receipt. Pairs with BF's planned fingerprinting tool for multi-account detection. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778602892678569)

...
last_catchup: 2026-05-20T07:19:41Z
status: active
retired_at: null
retired_reason: null
---
...
> [open] 2026-05-05 — new crypto pairs expansion request (22 pairs; 4 pending deploy, 2 need client clarification)
> Benjamin Galindo requested 22 new crypto pairs; originally 20 confirmed addable, OKB/KCS required a code change. On 2026-05-08 Benjamin asked whether Mahi LP pricing could be used instead of MatchTrade (too costly). On 2026-05-18 Isaac confirmed 15 remaining assets are priced via Kraken/Binance; TON, THETA, OKB, KCS still need a system deploy. MKR is no longer listed (replaced by SKY at 1 MKR = 24,000 SKY — price significantly different, needs client confirmation on which instrument to price). EOS has been relisted as Vaulta at most exchanges (1:1 swap, same price) — needs client confirmation whether to keep pricing as EOS. Isaac asked Mio to advise on both. No client response visible yet. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1779061823.502329)

> [open] 2026-05-08 — client requesting Mahi copy/group trading correlation script
> BrightFunded (Benjamin Galindo) asked on 2026-05-08 whether Mahi still has a trading correlation script for detecting copy/group trading, intending to combine it with new fingerprinting software for multi-account detection as a weekly review process. Cameron Hughes acknowledged on 2026-05-11. On 2026-05-12 Cameron H began sharing weekly coordinated trading detected data (CSV, 5.2 KB for 2026-05-05..2026-05-12 period) in #mahi-brightfunded; client acknowledged with ✅. The 2026-05-12 bi-weekly confirmed they want to pair the fingerprinting tool with this coordinated trading detection. Cameron H thinks the fingerprinting tool BF is implementing is payment fingerprinting (2026-05-15). Ongoing weekly cadence for coordinated trading data appears to be established, but formal script handoff/confirmation not yet visible. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778240384530379)

...
last_catchup: 2026-05-14T07:19:08Z
status: active
retired_at: null
retired_reason: null
---
...
> [open] 2026-05-12 — client asking whether April volume/purchase drop is industry-wide
> Bi-weekly call: BrightFunded flagged that account purchases and volumes dropped in April and want to know if this is an industry-wide trend. No Mahi response yet in channel. [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778581203791929)
...
> Benjamin Galindo (@here tagged) requested 22 new crypto pairs: XMR, BCH, ETC, MKR, TON, HBAR, ICP, VET, THETA, EOS, AVAX, ATOM, MANA, SAND, OKB, KCS, GRT, PYTH, EGLD, XTZ, COMP, SNX. Isaac Dann confirmed 20 can be added immediately; OKB and KCS require a code change and deployment. On 2026-05-06 Benjamin confirmed MatchTrade pricing and said he'd check with MT on OKB/KCS availability. On 2026-05-08 Benjamin asked whether Mahi pricing could be used for those instruments instead. On 2026-05-11 Benjamin chased again (tagging Mio Knights) — no Mahi resolution on the OKB/KCS code change yet. Bi-weekly 2026-05-12: client explicitly flagged that Match pricing would significantly increase their costs for the new instruments and are asking to price via other Mahi LPs instead — reinforces 2026-05-08 ask. Still open pending Mahi response. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778006518033119)

> [open] 2026-05-08 — client requesting Mahi copy/group trading correlation script / weekly reports
> BrightFunded (Benjamin Galindo) asked on 2026-05-08 whether Mahi still has a trading correlation script for detecting copy/group trading, intending to combine it with new fingerprinting software for multi-account detection as a weekly review process. Cameron Hughes acknowledged on 2026-05-11 ("Hey Ben, let me check the progress on that one"). On 2026-05-12 Cameron H posted the first weekly coordinated trading detection CSV (2026-05-05..2026-05-12) to #mahi-brightfunded; client replied positively ("Thanks mate will let you know if there are any questions"). Weekly report delivery has begun; underlying script-sharing ask may still be outstanding. Bi-weekly 2026-05-12: client confirmed intent to pair fingerprinting with Mahi's coordinated trading detection as an ongoing review process. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778240384530379) [delivery](https://mahifx.slack.com/archives/C08473TFD7Z/p1778602892678569)
...
- 2026-05-12 bi-weekly: Mio Knights is working on detecting abusive trading behaviour and will be reaching out to Mahi to collaborate. [permalink](https://mahifx.slack.com/archives/C084G40JXEE/p1778581203791929)
- 2026-05-12: Cameron Hughes sent first weekly coordinated trading detection CSV (2026-05-05..2026-05-12) to #mahi-brightfunded; client acknowledged positively. Marks start of a recurring weekly deliverable. [permalink](https://mahifx.slack.com/archives/C08473TFD7Z/p1778602892678569)

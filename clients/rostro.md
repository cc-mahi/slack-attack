...
key_people_overrides:
  ...
  - {name: "Lochlan", role: "departed — was championing Mahi at Rostro; moved to OZ (OneZero?); left on own terms (confirmed 2026-05-14 lunch meeting, contradicting earlier Reece account); Dave Cooney to reach Mike Ayres as replacement contact", confidence: low}
  - {name: "Mike Ayres", role: "senior leadership / 'the main boss' at Rostro; pulling the strings on risk/LP decisions; Dave Cooney to arrange Dubai catch-up", confidence: low}
  - {name: "Angus", role: "IC Markets — has relationship with Mike Ayres; drove IC rev share onboarding", confidence: low}
  - {name: "Manu", role: "Rostro-side — SI PnL allocation; sending questions on Pulse parameters", confidence: low}
last_catchup: 2026-05-15T07:28:15Z
---

## Recent issues

> [resolved] 2026-05-11 — IC Markets (MAHI_ICM) feed live; hedger exclusively switched to IC Markets by 2026-05-13
> Oli asked about ICM feed status; Kate confirmed pricing received across all FX. 2026-05-12: Oli asked to add IC_Markets to the soft (off-book/non-brokered) XAUUSD hedger for a short test — Rory King configured and restarted, tested; Oli then removed IC_MARKETS at ~16:37 BST after the test confirmed execution. 2026-05-13 08:40 BST: Oli asked Kate to change the hedger to exclusively go to IC Markets (brokered flow to remain elsewhere — Edgewater, Invast etc.); Kate actioned, first hedging trade with IC_MARKETS executed by 09:07 BST. Oli confirmed off-book hedger also facing IC. This is the enacted form of the IC rev share agreement (see Notable topics). [permalink](https://mahifx.slack.com/archives/C08AQKRU953/p1778487852170619) [test 2026-05-12](https://mahifx.slack.com/archives/C08AQKRU953/p1778595458.637889) [Rory confirms restart](https://mahifx.slack.com/archives/C08AQKRU953/p1778597478.616139) [Kate confirms exclusive IC 2026-05-13](https://mahifx.slack.com/archives/C08AQKRU953/p1778659621.525469)
...
> [resolved] 2026-05-06 — New LP proposal: route SI VIP hedging with no aggregation; enacted as IC Markets rev share by 2026-05-13
> Alex (Rostro) emailed Kate proposing to go live with a new LP offering tighter spreads in Gold and FX majors, initially routing SI VIP soft flow with no aggregation (full lifecycle to the LP), then phasing in more SI hedging flow later. Kate flagged internally: single-LP risk (no fallback if they widen/reject, citing Kama as precedent), book restructure required (VIP flow to separate book to ensure fully hedged), and reduced SI offsetting (more hedge volume = more spread paid). Resolved: the new LP is IC Markets; a rev share agreement was in place (Rostro sends soft FX flow to IC, receives IC crypto flow). By 2026-05-13 the hedger was reconfigured to exclusively route to IC_MARKETS with brokered flow remaining to other LPs. Failover via PXM if IC drops out. See also 2026-05-14 lunch meeting notes (Notable topics). [permalink](https://mahifx.slack.com/archives/C08ALS66EDC/p1778060197092949) [Kate's risks](https://mahifx.slack.com/archives/C08ALS66EDC/p1778060619854249) [Kate call notes 2026-05-12](https://mahifx.slack.com/archives/C08ALS66EDC/p1778576609.945019)

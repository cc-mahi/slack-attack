...
last_catchup: 2026-05-14T07:31:33Z
---

## Recent issues

> [open] 2026-05-13 — IC Markets hedger migration underway: all SI/off-book XAUUSD flow now routed to IC exclusively
> Following 2026-05-12 call (see call notes in Notable topics), Oli confirmed test trades proceeded. On 2026-05-12 15:17 BST Oli asked to add IC_MARKETS to the hedger for XAUUSD "soft" (SI/off-book) flow only — not brokered — as a short 10–20 min test; Rory actioned (hedger restarted ~15:51 BST, IC_MARKETS removed again at 16:37 after test). By 2026-05-13 08:40 BST Oli requested the hedger be switched *exclusively* to IC Markets (brokered flow unchanged). Kate actioned at 09:07 BST ("config updated, first hedging trade executed with IC_MARKETS"); Oli confirmed off-book hedger also pointing to IC at 10:49 BST, Kate confirmed yes. Migration plan: start XAUUSD, then move to all FX. Brokered flow continues via existing LPs. Failover: if IC drop out, PXM routes to backup LP transparently. No issues reported post-switch. [permalink](https://mahifx.slack.com/archives/C08AQKRU953/p1778595458637889) [Rory test live](https://mahifx.slack.com/archives/C08AQKRU953/p1778597478616139) [Oli: go exclusive](https://mahifx.slack.com/archives/C08AQKRU953/p1778658000933659) [Kate: first hedge trade done](https://mahifx.slack.com/archives/C08AQKRU953/p1778659621525469) [off-book confirmed](https://mahifx.slack.com/archives/C08AQKRU953/p1778665790782699)

> [resolved] 2026-05-12 — Limit order rejections: "Internalisation Disabled IoC expired" (Andreas)
> Andreas queried a batch of order rejections. Rory explained: limit orders were sent to Invast but the orders were off-market at the time, resulting in cancellation with reason *Internalisation Disabled IoC expired*. Client acknowledged. [permalink](https://mahifx.slack.com/archives/C08AQKRU953/p1778586540808459) [Rory explains](https://mahifx.slack.com/archives/C08AQKRU953/p1778588368663989)
...
> [resolved] 2026-05-06 — New LP proposal: route SI VIP hedging with no aggregation; Kate flagged risks
> Alex (Rostro) emailed Kate proposing to go live with a new LP offering tighter spreads in Gold and FX majors, initially routing SI VIP soft flow with no aggregation (full lifecycle to the LP), then phasing in more SI hedging flow later. Kate flagged internally: single-LP risk (no fallback if they widen/reject, citing Kama as precedent), book restructure required (VIP flow to separate book to ensure fully hedged), and reduced SI offsetting (more hedge volume = more spread paid). Resolved: this is the IC Markets rev-share deal that went live 2026-05-13 (see 2026-05-13 hedger migration entry); failover via PXM addresses the single-LP risk. [permalink](https://mahifx.slack.com/archives/C08ALS66EDC/p1778060197092949) [Kate's risks](https://mahifx.slack.com/archives/C08ALS66EDC/p1778060619854249)
...
- 2026-05-12 — Call notes (Kate): Rostro onboarding IC Markets under a rev-share agreement. All SI book flow to be hedged to IC (starting XAUUSD, then all FX); brokered flow stays with existing LPs. Business does not want to hold the risk, hence the rev-share structure. Failover plan: if IC drops, PXM routes to a backup LP transparently. Test trades proceeded same day. [permalink](https://mahifx.slack.com/archives/C08ALS66EDC/p1778576609945019)
- 2026-05-12 — Management relationship concern (Bonnie): Bonnie flagged worry about the Rostro account given Lochlan's departure; asked David Cooney whether he had reached Michael Ayres. David Cooney deferred: "why don't you guys catch up with Oli and then we can decide whether I reach out to Ayres." Kate confirmed a call with Oli was scheduled for 2026-05-13. No update on Ayres contact yet. [permalink](https://mahifx.slack.com/archives/C08ALS66EDC/p1778577012256099) [David defers](https://mahifx.slack.com/archives/C08ALS66EDC/p1778577564988679)

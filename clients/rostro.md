...
last_catchup: 2026-05-21T16:07:50Z
---
...
> [open] 2026-05-21 — IC Markets rev share routing rework live (stage 1)
> Rostro internal decision (shared 2026-05-20 call): rather than nominating tags for rev-share inclusion, they will nominate exclusions. Revised routing: all internalised G7+metals (rev share and non-rev-share) → SI book, hedged to IC; non-rev-share crosses + excluded/toxic tags → new NON_REV_SHARE_HOUSE book, hedged to alternative LP pool via hybridHedgerNonRevShare1; rev-share crosses → STP to IC via PXM; rev-share G7+metals STP'd due to classifier → IC; non-rev-share G7+metals STP'd due to classifier → alt pool. Kate confirmed routing in mahi-rostro 2026-05-20. Oli provided excluded tags: `109_*`, `118_*`, `122_*`, `138_*`, `163_*`. Stage 1 risk-splitting rules deployed 2026-05-21 ~16:33 BST. Test of FA feed post-PXM restarts also planned. [permalink](https://mahifx.slack.com/archives/C08AQKRU953/p1779280291256629) [internal call notes](https://mahifx.slack.com/archives/C08ALS66EDC/p1779370496170439) [stage 1 live](https://mahifx.slack.com/archives/C08ALS66EDC/p1779377630073999)

...
> [open] 2025-04-30 — Retail pricing degradation: wide spreads on majors / LR on retail published rate
...
- 2025-06-18 — JPY crypto hedging mechanism explained: Tom asked how BTCJPY client flow is hedged given Mahi hedges as BTCUSD — what happens to the JPY exposure? Isaac: USDJPY hedged through same HRP feeds as retail. Amir: Compass hedging is bucketed by asset (not 1-to-1 per client trade); there is no direct mapping between a specific client JPY crypto trade and a specific USDJPY hedge leg. [permalink](https://mahifx.slack.com/archives/C06TW3D8NMV/p1750233313457629)

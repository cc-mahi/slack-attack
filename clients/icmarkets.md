...
key_people_overrides:
  ...
  - {name: "Dimitrios Lambrou", role: "IC Markets — joined Slack channel 2026-05-18", confidence: low}
...
last_catchup: 2026-05-19T07:19:40Z
---

## Recent issues

> [resolved] 2026-05-16 — XBTUSD liquidity warning (Michalis): transient, explained by Cooney
> Michalis (IC side) reported error "Failed to find matching volume at liquidity sources for either Hedge execution or warehouse VWAP determination" on XBTUSD. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778932720.894889) Cooney explained: a monitoring node widens the stack in sympathy with external stacks when the difference exceeds a threshold; it briefly couldn't find enough liquidity for the back elements, alerted, and stopped publishing affected elements until liquidity recovered. Passing warning — no action required. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778933724.003609)

> [resolved] 2026-05-14 — OZFIXTakerMahiFX not connected on IC secondary hub; Nathan Burch fixed
> IC reported OZFIXTakerMahiFX not connected on their secondary hub at 21:07 BST, flagging urgency as they needed to switch before EOD. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778789271.070959) Nathan Burch added the secondary hub IP (168.245.178.93) to the config alongside the existing primary IP (168.245.178.232), so failover now works automatically. IC confirmed OK. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778792200.411999) 2026-05-15 follow-up: IC noted this is part of a load-balancing exercise (secondary hub becoming live, not just failover); MT servers moving to secondary hub EOD Friday 16 May 5pm NYC. Liam Cordelle, Will Carter and James tagged. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778826393.119389)

> [resolved] 2026-05-13 — Pricing latency filter misconfiguration (crypto-ny): indicative pricing during low-activity periods
> Daria found the pricing backtest pointing to the latency filter as the cause of indicative pricing in IC Markets crypto-ny env. Athena MD queries showed trigger time up to 9s behind transaction time during affected periods in both Toa APN1 and IC Markets envs. Root cause: pricing model looks up filters using its own market (not the LP market), so the filter override at icmarkets-crypto-ny-admin wasn't being applied. Daria added a local override for crypto instruments; pricer processes now logging correct filters. [permalink](https://mahifx.slack.com/archives/C07TZ00FK1Q/p1778636377.654129)

> [resolved] 2026-05-12 — signalProcessFI1 memory spike + restart (~15:10 BST)
> Inald reported signalProcessFI1 restarted with memory usage jumping from ~15:10 BST. [permalink](https://mahifx.slack.com/archives/C07TZ00FK1Q/p1778602202.367479) No follow-up escalation or client impact reported.

> [open] 2026-05-12 — BTCUSD hedge enqueue failures (early May weekend): no Maker quotes on book
> IC reported (2026-05-12) that multiple BTCUSD trades from early May (2026-05-02) had "Problem enqueuing Hedge executions: No quotes currently on book for symbol BTCUSD" — six logged instances, all small (0.01–0.02 BTC), spanning 02:32–21:11 UTC on 2026-05-02. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778580830.867009) Nathan Burch tagged; no reply in thread. Open — root cause not confirmed.
...
> [resolved] 2026-05-06 — BTCUSD/ETHUSD weekend latency complaint; root cause found and fixed 2026-05-13
> Joanna Theophanous (i.theophanous, IC side) reported high latency on several BTCUSD and ETHUSD trades over the weekend (examples attached as image). [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778085021583819) Kate Stagg acknowledged. Nathan Burch investigated overnight (01:34 UTC 2026-05-07): all Compass processing within ~100ms, order handling latency dashboard clean — no Mahi-side latency found; shared the order events trace URL and asked IC for further information or oneZero logs. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778114040166719) Cameron Hughes separately escalated to #eod-trading-analytics-handovers asking NZ to look into it. 2026-05-13: Daria identified root cause — the latency filter configuration was not being applied correctly (pricing model looks up filters using its own market rather than the LP market, so a filter override wasn't being applied), causing the Toa rate to be filtered out and producing indicative pricing. Impact limited to periods with little pricing activity. Daria corrected the config on the icmarkets-crypto-ny-admin env; the pricer processes are now logging correct filters applied. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778636027.354749)

> [open] 2026-05-06 — New IC team member Pavlos Elpidorou (Head of Market Risk): Compass + Echo access requested; onboarding call being arranged
> IC asked Mahi to create Compass and Echo accounts for new team member Pavlos Elpidorou (p.elpidorou@icmarketsgroup.com). [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778055176495339) Will Carter replied "Morning, will do" but no confirmation of completion was posted in the window. Pavlos joined the channel at 18:31 BST same day — access may have been provisioned but not confirmed on-thread. 2026-05-13: IC posted that Pavlos is Head of Market Risk and requested a call with Will Carter and Cooney to brief him on Compass and Echo. [permalink](https://mahifx.slack.com/archives/C07UBJNUWG1/p1778659347.695939) Cooney confirmed availability Thurs/Fri; IC scheduled a call for the following day (Fri 15 May). Still no on-thread confirmation that Compass/Echo access was fully provisioned.
...
- 2026-05-13: Pavlos Elpidorou confirmed as Head of Market Risk at IC. Call scheduled with Cooney + Will Carter to brief him on Compass/Echo; system access provisioning unconfirmed on-thread.
- 2026-05-13: Daria fixed indicative pricing bug in IC crypto-ny env — latency filter override not being applied due to model using own-market lookup; corrected with local instrument override.
- 2026-05-14/15: IC secondary hub FIX connectivity resolved; IC doing load-balancing exercise moving MT servers to secondary hub EOD 16 May. Liam Cordelle, Will Carter, James tagged.
- 2026-05-16: Transient XBTUSD volume/liquidity warning explained to IC; no action required.
- 2026-05-18: Dimitrios Lambrou joined #mahi-ic-markets. Role unknown — flagged low-confidence in key_people_overrides for next pass.

...
> [open] 2026-06-16 — FX/Metals system failure; second recurrence 2026-06-17 11:46 BST; RCA in progress, fix expected 2026-06-18
> Diego (Pepper OZ) flagged NY_3 and NY_4 FX/Metals connections returning no order confirmations at 17:10 BST 2026-06-16 — hundreds of outtrades accumulating. Liam took down NYC gateways to force failover to LDN; LDN also showed a cancel spike. FX env back up by 17:39 BST. Kill switch tripped on both LDN and NYC at 17:42 BST. Hedgers left OFF and turned back on by 18:06 BST (William Denny). Crypto env unaffected. **Second recurrence 2026-06-17 11:46 BST**: Liam ("Shitting itself again"), restarted systemGuaranteed2 brokers; kill switches triggered by restarts, not underlying issue. Arun flagged critical swap usage on pepperstone-ny-trading-1 (8708MB) as a potential contributor (PagerDuty Q09BXOMYXUCKD5). **RCA update 2026-06-17 09:52 BST (Liam to Pepper)**: root cause identified as "subtle regression relating to our internal messaging"; kill switch didn't trigger for the original incident because the message-queueing back-pressure profile wasn't met — criteria to be expanded. Improved alerting/diagnostics deployed in same-day LDN+NY release (~15:48/16:26 BST); monitoring added to give early warning. Fix expected "sometime tomorrow" (2026-06-18). Liam monitored through FOMC same evening (no new issues reported). Full RCA write-up to follow once investigation complete. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1781626246642399) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1781686366662509) [permalink](https://mahifx.slack.com/archives/C033K2P0RPT/p1781693179021629) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1781702246969769) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1781716831028839)

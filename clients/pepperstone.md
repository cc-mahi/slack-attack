...
key_people_overrides:
  ...
  - {name: "Antonio Aguilar", role: "ops / exchange trading (Pepperstone)", confidence: low}
last_catchup: 2026-05-19T07:34:51Z
---
...
> Stephen flagged that during a ~$500k AUD UST trade (382k units at 1.38), hedgers kept retrying B2C2 despite insufficient-balance errors rather than switching to Crossover/LMAX sooner, leaving the position partially exposed. Marianna clarified the LP wasn't deprioritised fast enough. Daria adjusted hedger config (further restricting B2C2, reordered rules so backstop can fire), increased liquidity layers; Stephen raised TOB to 10k UST. Separately, fills were slow (250 UST parcels) because only the first two layers were inside the client's limit price — Stephen gathering client feedback on acceptable fill timeframe. Daria still simulating the config change. NOP alignment between Compass and B2C2 limits also discussed — Stephen noted treasury deposits/withdrawals make Compass NOP not reflective of underlying. 2026-05-18: second round of large UST trade, improved from 250 to 1000 UST clips but Stephen still views fill speed as too slow — wants clips of 10k–20k; asked whether refresh rates are the lever; no reply yet. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778489962714849) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778536863658599) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778560468492269) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1779086987830109)

> [open] 2026-05-11 — Inventory hedger (InvNY1 / XAG) repeatedly off after restarts
> MK reported that the inventory hedger (CFD desk) did not come up automatically after the 2026-05-11 weekend restart. Kate Stagg added config to ensure auto-start and bounced systemStateMonitor; MK initially confirmed resolved. However on 2026-05-15 Stephen again reported XAG (InvNY1) was off after restarts — Daria checked and switched it back on (~02:31–02:36 UTC); noted she'd review the notifications. No automated fix confirmed yet for XAG specifically. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778506644097019) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778808580296939)
...
> [open] 2026-05-06 — custom2 classification not triggering as expected; MK/Reece building own classifier in parallel
> Reece asked to clear the `analytics.counterpartyClassification.B Book.custom2.badCheck` global list (193 entries); Rory cleared it. After refresh, Reece observed that CP 51397366 is not landing in custom2 despite what appear to be negative yields at 5s. Shyam (internal) reviewed: custom2 is configured as OR across horizons (5s/10s/30s/60s/2m/4m), not AND — but the aggregated yield profile for this CP shows no negative horizons, so classification seems correct yet Reece expected otherwise. Shyam flagged for further investigation. 2026-05-19: Daria notes (internal) that MK and Reece have since built their own external classifier because they were unable to configure Mahi's classifier to their specs — specifically wanting AND logic across horizons (persistent yield: offside at 30s AND still offside at 4m, not OR). MK asking for automated upload of their classifier's counterparty list; Daria suggested manual JSON upload but MK wants low-touch, ideally DB-direct insert. Daria flagged the DB-direct approach as risky and raised with Liam — no reply yet. Daria also offered to spec out the classifier for MK's AND-logic requirement as an alternative. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1777984346581039) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778038180841259) [permalink](https://mahifx.slack.com/archives/C033K2P0RPT/p1778043575578009) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778047876914949) [permalink](https://mahifx.slack.com/archives/C033K2P0RPT/p1779146841798919)
...
> [open] 2026-04-27 — Cpty 2075077 not routed to Dynamic Arbitrageurs (root cause: fillAtWssPrice override); FX/Metals fix pending
> Reece's 6-Apr 22:00 UTC XAGUSD fill at 72.55 instead of 73.246: at 22:03:39.307 an LP bid collapse caused B_BOOK to publish a WSS-clamped bid=72.25/offer=72.55; 65ms later the SELL filled at exactly 72.55 — `fillAtWssPrice` was overriding the continuity-pool execution for Dynamic Arbitrageurs. WSS overrides continuity workflow when fired. Brokered workflow unaffected (only internalised orders). 2026-05-13: dev made a change so that forcibly internalised orders can be excluded from the fill-at-WSS-price logic — planned deploy to FX/Metals env during metal close using LDN/NY failover. 2026-05-14: FX env deploy failed and was rolled back (Modulus counterparty tag fix, Zendesk 22879, deployed separately to Modulus on 2026-05-15 — internal-pepperstone); arb client fillAtWssPrice fix still pending FX/Metals deploy. Stephen confirmed happy to wait for a correct update. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1777305102439059) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778708983110969) [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778797764931869)
...
> [open] 2026-04-01 — Crypto weekend reboot sequencing causing simultaneous NY+LDN downtime; schedule adjusted
> Weekend volumes ≥ weekday; weekend reboots left traders off-state. 2026-05-18: Stephen (crypto spot) flagged that simultaneous NY+LDN restarts cause liquidity spikes — the "start in off state" config from Feb means both regions go down together, leaving very thin remaining liquidity on the chart. Daria clarified current schedule: NY restarts at 15:25 Sunday NY, LDN at 16:25 Sunday NY. Agreed fix for the coming weekend: keep NY timing, push LDN out by an additional hour to 17:25 Sunday NY to widen the window between regions. Components per region: NY (propTraderCrypto1, fixMarketData3, fixOrders3), LDN (propTraderCryptoBackup1, fixMarketDataModulus1, fixOrdersModulus1). Monitoring for NZ hours post-reboot remains manual. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1779075264717449)
...
- 2026-05-18 — Kraken Spot FIX integration (SOW #3) underway: Liam requested Pepperstone-side UAT credentials for FIX API onboarding; Pepper confirmed they'd arrange and asked for Mahi's IP whitelist; Liam provided 3.232.54.170. Active. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1779111036533119)
- 2026-05-14 — LMAX Digital maintenance window moving from Friday evenings to Saturday mornings effective 2026-05-23 (first: Sat 23 May, 08:00–09:00 UTC). No config change needed on Mahi side — multi-venue pricing/hedging already handles the gap. Pepper flagged some alerts will fire during the window. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1778757837376979)
- 2026-05-15 — Modulus counterparty tag (counterparty field capture on trades) fix deployed (Zendesk 22879); traders restarted region-by-region on 2026-05-14 to pick up the change. [permalink](https://mahifx.slack.com/archives/C033K2P0RPT/p1778800348797699)
- 2026-05-18 — Cpty 1281396 queried by Stephen as potential problematic arbitrageur; Daria confirmed classification healthy via Echo yield profile — Dynamic Arbitrageur rule producing positive spread on internalised trades. [permalink](https://mahifx.slack.com/archives/C06AR8MT8NT/p1779081483070399)
